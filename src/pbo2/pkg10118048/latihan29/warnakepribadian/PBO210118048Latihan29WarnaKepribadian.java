...
package pbo2.pkg10118048.latihan29.warnakepribadian;
 ...
 * KELAS : PBO2
 * NIM : 10118048
 * Deskripsi program : melihat kepribadian seseorang dari warna yang dipilih
 */
public class PBO210118048Latihan29WarnaKepribadian {
    ...
    public static void main(String[] args) {
        ...
        tampilHasil(warnaMu, nama);
    }
    
    public static void tampilHasil(String warnaMu, String nama) {
        System.out.println("\n===HASIL TEST KEPRIBADIAN " +nama+ "===");
        warnaPilihan(warnaMu);
    } 
    
    public static void warnaPilihan(String warnaMu) {
        switch (warnaMu) {
            case "BIRU" :{
